...
public class API extends BasePage {
    ...
    /**
     * Verify the API login functionality.
     * This test ensures that the login API is functioning correctly by sending a POST
     * request with the required credentials and validating the response status code and body.
     */
    @Test
    ...
    /**
     * Perform automatic login and obtain authentication token.
     * This method sends a POST request to the authentication API with the necessary headers and body,
     * and validates the response. If successful, the Gn-Access-Token is retrieved and logged for further use.
     *
     * @throws AssertionError if the response status code is not 200 or if the token is null.
     */
    @BeforeMethod
    ...
    /**
     * Pauses the execution of the test for a specified amount of time.
     * This method will cause the thread to sleep for the number of seconds passed as an argument.
     *
     * @param sec The number of seconds for which the thread should sleep.
    ...
    /**
     * Verify the API response for retrieving the brand profile details.
     * This test sends a GET request to the API to fetch the brand profile details using the subdomain,
     * and validates the response status code and body.
     */
    @Test
    ...
    /**
     * Verify the API response for retrieving brand registration subdomain suggestions.
     * This test sends a GET request to the API to get subdomain suggestions based on the provided brand name.
     * It then validates the response status code and body.
     */
    @Test
    ...
    /**
     * Verify the API response for email validation during brand registration.
     * This test sends a GET request to the API to validate the provided email address for brand registration.
     * It then checks the response status code and validates the response body.
     */
    ...
    /**
     * Verify the API response for requesting a password reset via email.
     * This test sends a GET request to the API to initiate a password reset process by providing an email address.
     * It then checks the response status code and validates the response body.
     */
    ...
    /**
     * Test to verify the API response for fetching brand invitations.
     * This test sends a GET request to the "brand/invitations" endpoint and validates the response status code and body.
     * It checks if the request is successful and if the returned status code is 200 (OK).
     */
    //https://brands-api.qa.begenuin.com/api/v1/brand/invitations
    @Test
    public void API_Demo_Brand_InvitationTest() {
        common.logPrint("Step ::API Test Started....");
    ...
    /**
     * Verify the API response for fetching community guidelines.
     * This test sends a GET request to the "/api/v3/community/guidelines" endpoint to retrieve the community guidelines.
     * It checks the response status code to ensure it is 200 (OK) and validates the response body.
     */
    ...
    /**
     * Verify the API response for fetching community members.
     * This test sends a GET request to the "/api/v3/community/members" endpoint with a specific community ID
     * to retrieve the list of members in the community.
     * It checks the response status code to ensure it is 200 (OK) and validates the response body.
     */
    ...
    /**
     * Verify the API response for fetching loop details.
     * This test sends a GET request to the "/api/v1/loops" endpoint with the query parameter `is_loop_names_only=true`
     * to retrieve the loop names from the API.
     * It checks the response status code to ensure it is 200 (OK) and validates the response body.
     */
    @Test
    ...
    /**
     * Verify the API response for fetching communities by a specific user.
     * This test sends a GET request to the "/api/v1/communities_by_user" endpoint with several query parameters,
     * including `user_id`, `user_community_joined`, `limit`, and `query_string`, to retrieve community details related to a user.
     * It checks the response status code to ensure it is 200 (OK) and validates the response body.
     */
    @Test
    ...
    /**
     * Verify the functionality of the Brand Search API.
     * This test ensures that the Brand Search API is correctly returning a response when
     * searching for a brand using a specific email query string. It verifies that the
     * status code of the response is 200 and logs the response body for further inspection.
     * The test pauses for 15 seconds after completion, though dynamic waits are recommended
    ...
    /**
     * Verify the functionality of the Community API.
     * This test ensures that the Community API is functioning correctly by sending a GET
     * request with a specific community ID and validating the response status code and body.
     */
    @Test
    ...
    /**
     * Verify the functionality of the Community Handle Suggestion API.
     * This test ensures that the Community Handle Suggestion API is functioning correctly
     * by sending a GET request with a specific name and validating the response status code and body.
     */
    @Test
    ...
    /**
     * Verify the functionality of the Community Requests API.
     * This test ensures that the Community Requests API is functioning correctly by sending a GET
     * request with a specific community ID and validating the response status code and body.
     */
    @Test
    ...
    /**
     * Verify the functionality of the Loop Pagination API.
     * This test ensures that the Loop Pagination API correctly handles pagination by sending a GET
     * request with specific pagination parameters (page number, limit, and sort criteria) and
    ...
    /**
     * Verify the functionality of the Loop Subscribers API.
     * This test ensures that the Loop Subscribers API correctly returns the list of subscribers
     * for a given chat ID by sending a GET request with the specified parameters and
     * validating the response status code and body.
     */
    @Test
    ...
    /**
     * Verify the API response for fetching loop collaborators.
     * This test sends a GET request to the API to retrieve a list of loop collaborators
     * associated with a specific chat ID. It checks the response status code
    ...
    /**
     * Verify the API response for fetching paginated loop posts.
     * This test sends a GET request to the API to retrieve a list of loop posts,
     * with pagination parameters such as page number, limit, sorting options (loop, ascending).
     * It checks the response status code and validates the response body.
     */
    @Test
    ...
    /**
     * Verify the API response for fetching community loop data.
     * This test sends a GET request to the API to retrieve loop information
     * for a specific community, identified by its community ID and slug.
     * It checks the response status code and validates the response body.
     */
    @Test
    ...
    /**
     * Verify the API response when checking if a user exists.
     * This test sends a GET request to the API to check if a user exists
     * by providing their email and brand ID. It validates the response status
     * code and verifies the response body to ensure the correct data is returned.
     */
    @Test
    ...
    /**
     * Verify the API response for fetching mentions in a community.
     * This test sends a GET request to the API to fetch mentions based on a query string
     * and community ID. It validates the response status code and checks the response body
     * to ensure that mentions are returned correctly based on the given query string.
     */
    @Test
    ...
    /**
     * Verify the API response for fetching available fonts.
     * This test sends a GET request to the API to fetch a list of available fonts.
     * It validates the response status code and ensures that the fonts are returned correctly
    ...
    /**
     * Verify the API response for generating a signed URL.
     * This test sends a GET request to the API to fetch a signed URL for uploading a file with the specified content type and path.
     * It ensures that the API returns a valid signed URL with a successful response status.
     */
    @Test
    ...
    /**
     * Verify the API response for fetching brand user details.
     * This test sends a GET request to retrieve the list of brand users, filtered by user type and with a specified limit on the number of users.
     * It ensures that the API returns a valid response with the expected status code and data for the brand users.
     */
    @Test
    ...
    /**
     * Verify the API response for fetching subdomain suggestions based on the provided name.
     * This test sends a GET request to fetch subdomain suggestions based on the input name, ensuring that the API returns a valid response.
     * It validates the response's status code and body content.
     */
    @Test
    ...
    /**
     * Verify the API response for fetching brand details based on the provided name for registration.
     * This test sends a GET request to fetch brand registration details using the provided name, ensuring that the API returns a valid response.
     * It validates the response's status code and body content.
     */
    @Test
    ...
    /**
     * Verify the API response when resending the email for a brand.
     * This test sends a GET request to the API to trigger an email resend and ensures the response is valid.
     * It validates that the response status code is correct, and checks the body for proper feedback.
     */
    @Test
    ...
    /**
     * Verify the API response for fetching dynamic CBR (Customer Brand Relationship) data and brand details.
     * This test sends a GET request to the API to fetch brand details based on the provided brand ID and completion status
     * of onboarding steps. It ensures that the API returns the correct response and verifies the success of the request.
     */
    @Test
    ...
    /**
     * Verify the API response when validating a community handle.
     * This test sends a GET request to validate whether a specific handle is available or taken in the community.
     * It ensures that the API returns the correct response status and validates the handle as expected.
     */
    @Test
    ...
    /**
     * Verify the API response when retrieving comments based on specific query parameters.
     * This test sends a GET request to fetch comments with filters such as limit, page, query string,
     * and sorting options. It checks the response status and body to ensure the API behaves as expected.
     */
    @Test
    ...
    /**
     * Verify the API response when retrieving available payment methods with specific query parameters.
     * This test sends a GET request to fetch payment methods with a limit applied to the response.
     * It ensures that the response status is successful and the expected data is returned.
     */
    @Test
    ...
    /**
     * Verify the API response for retrieving transactions with pagination.
     * This test sends a GET request to fetch a list of transactions with specified pagination parameters (page number and limit).
     * It ensures that the response status is successful (200 OK) and validates the response body.
     */
    ...
    /**
     * Verify the API response for retrieving the wallet balance.
     * This test sends a GET request to fetch the current wallet balance for the authenticated user.
     * It ensures that the response status is successful (200 OK) and validates the response body.
     */
    @Test
...
//        String email = "rahul+1@perfectqaservices.com";
    ...
    @Test
    public void API_Conversation_Members() {
    ...
    @Test
    public void API_Search_Recent_Delete_Test() {
    ...
    @Test
    public void API_Video_CreateUploadUrl_Test() {
        System.out.println("Step :: API Test Started");
...
//        request.header("Authorization", "Bearer " + gnAccessToken);
    ...
    @Test
    public void API_AutoSummarize_Test() {
        System.out.println("Step :: API Test Started for Auto Summarize...");
        ...
        Response response = request
                .contentType("application/json")
                .queryParam("transcript", "djicojdijd")
                .queryParam("no_of_clicks", 1)
                .get("/api/v3/auto_summarize");
    ...
    @Test
    public void API_GenerateUploadUrl_Test() {
        System.out.println("Step :: API Test Started for Generate Upload URL...");
        ...
        Response response = request
                .contentType("application/json")
                .queryParam("contentType", "audio/wav")
                .queryParam("path", "audio/659e9bb4-fc10-4dce-a856-20bff0e9f387_1632915580779.mp3")
                .get("/api/v3/tmp_storage/generate_upload_url");
...
//        request.header("Authorization", "Bearer " + gnAccessToken);
    ...
    @Test
    public void API_Developer_SocketConnection_Username_Test1() {
        common.logPrint("Step :: API Test Started....");
        //set base URI
        RestAssured.baseURI = "https://nodejs.qa.begenuin.com";
