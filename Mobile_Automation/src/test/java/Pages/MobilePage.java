...
public class MobilePage extends MobileBasePage {
    ...
    String COMMUNITYHANDLEFIELD = "//androidx.cardview.widget.CardView[@resource-id=\"com.begenuin.begenuin.qa:id/cvGenerate\"]/android.widget.LinearLayout";
    ...
    String NEWCOMMUNITY = "(//android.widget.ImageView[@resource-id=\"com.begenuin.begenuin.qa:id/space_icon\"])[3]";
    String CREATECOMMUNITYMANUALLY = "//androidx.cardview.widget.CardView[@resource-id=\"com.begenuin.begenuin.qa:id/cardCreateCommunity\"]/android.widget.LinearLayout/android.widget.ImageView";
    String AUTOCREATECOMMUNITY = "//android.widget.LinearLayout[@resource-id=\"com.begenuin.begenuin.qa:id/appBarLayout\"]/android.widget.FrameLayout/android.view.ViewGroup";
    ...
    String SELECTBEGENUINBRAND = "//android.widget.TextView[@resource-id=\"com.begenuin.begenuin.qa:id/tvBrandName\" and @text=\"Begenuin\"]";
    String SELECTCATEGORY = "//android.widget.TextView[@resource-id=\"com.begenuin.begenuin.qa:id/tvCommunityCategory\" and @text=\"Digital Advertising\"]";
    ...
    String RECORDAPOSTBTN = "//android.widget.TextView[@text=\"Record a post\"]";
    ...
    String POSTBUTTON = "(//android.widget.LinearLayout[@resource-id=\"com.begenuin.begenuin.qa:id/llBottomLayout\"])[2]";
    ...
    String DONEBUTTON = "(//android.widget.LinearLayout[@resource-id=\"com.begenuin.begenuin.qa:id/llBottomLayout\"])[2]";
    ...
    String CREATELOOP1 = "//android.widget.Button[@resource-id=\"com.begenuin.begenuin.qa:id/btnCreateNewLoop\"]";
    ...
    String USEPHONENUMBER = "//android.widget.TextView[@text=\"Use phone number instead\"]";
    String CLOSEBUTTON = "//android.widget.ImageView[@resource-id=\"com.begenuin.begenuin.qa:id/ivClose\"]";
    String BACKBUTTON = "//android.widget.ImageView[@resource-id=\"com.begenuin.begenuin.qa:id/ivBack\"]";
    ...
    public void logInWithPhoneNumber() throws Exception {
        ...
        common.pause(10);
        action.click(driver, USEPHONENUMBER, "Use phoen number");
    ...
    public void verifyLoginPageElementsArePresent() throws Exception {
        ...
        common.pause(8);
        action.click(driver, LOGIN, "Log In");
        action.waitForElement(driver, USEPHONENUMBER);
        action.click(driver, USEPHONENUMBER, "Phone");
...
//        Assert.assertEquals(containTextCreate, "Create");
        ...
        Assert.assertEquals(containTextProfile, "@Tedx");
    ...
    public void signUpFlow() throws InterruptedException {
        ...
        while (retryCount < maxRetries) {
            ...
            action.waitForElementToBeClickable(driver, CREATECOMMUNITY);

            if (action.isElementVisible(driver, CREATECOMMUNITY)) {
                action.click(driver, CREATECOMMUNITY, "Create Community...");
                isCreated = true;
                break; // Successfully created, exit loop
            } else {
                action.click(driver, BACKBUTTON, "Back Button");
                retryCount++;
            }
        }

        if (!isCreated) {
            throw new RuntimeException("Failed to create community after " + maxRetries + " attempts.");
        }
        ...
        Assert.assertEquals(communityCreated, "Creating your community…");
...
//        action.click(driver, CREATEICON, "Create");
        ...
        action.waitForElement(driver, SELECTBEGENUINBRAND);
        action.click(driver, SELECTBEGENUINBRAND, "Begenuin");
    ...
    public void createLoop() {
        ...
        Assert.assertEquals(LoopCreatedMessage, "Group created!");
